...
from ..storage.serializers.datapak import DataPakSerializer
from ..storage.serializers.pickle import PickleSerializer
from ..storage.serializers.serializer import Serializer
from ..utils.bunch import Bunch
from ..utils.frames import reorder_columns

# Dictionary of available serializers
SERIALIZERS = {
    "DataPakSerializer": DataPakSerializer,
...
def runs_to_sql(id_experiment: uuid.UUID, meta: dict, runs: Runs):
    """
    ...
    # )
    dtype = {"id_experiment": models.Uuid}
    dtype.update({"id_run": models.Uuid})
    dtype.update(
        {col_name: models.LargeBinary for col_name in meta.runs.columns.serialized}
    )
