...
class Session:
    ...
    def __init__(self, url: str = None, ask_password: bool = None, db: Database = None):
        """
    ...
    def datastream_server(self):
        try:
            from .storage.datastream import DataStreamServer
    ...
    def create_experiment(self, name: str = None, **fields) -> Experiment:
        """
    ...
    def load_experiment(
        ...
        return Experiment.load(
            self.db, name=name, id_experiment=id_experiment, unsafe_pickle=unsafe_pickle
        )

    def persist_experiment(
        self, experiment: Experiment, name: str = None, if_exists: IfExists = "fail"
    ) -> Experiment:
        """
...
def create_experiment(
    name: str = None, url: str = None, ask_password: bool = None, **fields
) -> Experiment:
    """
    Create a new experiment bound to a new session. Shortcut to create a single experiment.
    """

    return Session(url=url, ask_password=ask_password).create_experiment(
        name=name, **fields
    )
